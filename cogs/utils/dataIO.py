...
class DataIO():
    ...
    def save_json(self, filename, data):
        """Sauvegarde atomiquement le fichier json"""
        ...
        try:
            ...
            self.logger.exception("Tentative d'écriture du fichier {} mais la "
                                  "vérification d'intégrité JSON sur le fichier tmp a échoué."
    ...
    def is_valid_json(self, filename):
        """Vérifie si le fichier json existe / est lisible"""
        try:
    ...
    def _legacy_fileio(self, filename, IO, data=None):
        """Ancien fileIO fourni pour la rétrocompatibilité"""
        if IO == "save" and data != None:
            ...
            raise InvalidFileIO("FileIO a été appelé avec des paramètres"
                " invalides")
